...
const Feutures_section = () => {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Experience the thrill of competition, the camaraderie of fellow athletes, and the pride of representing their team or country. Whether winning or losing, the journey  cultivates valuable life lessons and unforgettable memories, reinforcing the spirit of sportsmanship and personal growth.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">TEAM MANAGEMENT</h3>
              <p class="text-gray-500 dark:text-gray-400">Tools for creating and managing team rosters, scheduling practices and games, and tracking player statistics and performance metrics. </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">REGISTRATION MANAGEMENT</h3>
              <p class="text-gray-500 dark:text-gray-400">This feature typically includes online registration forms, membership database management, and automated processing of membership fees and renewals.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">PERFORMANCE TRACKING</h3>
              <p class="text-gray-500 dark:text-gray-400">tracking metrics such as goals, assists, playing time, and other relevant statistics.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">SPONSORSHIP AND FUNDRAISING</h3>
              <p class="text-gray-500 dark:text-gray-400">Sponsorship Opportunities: Information and management of sponsorship deals.
              Fundraising Campaigns: Tools for creating and managing fundraising campaigns.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">ANALYTICS AND REPORTING</h3>
              <p class="text-gray-500 dark:text-gray-400">Dashboards: Visual dashboards for an overview of key metrics and performance indicators.
              Custom Reports: Generate custom reports based on specific criteria.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Data Security: Secure user data with encryption and compliance with data protection regulations.
              Access Control: Role-based access control to restrict access to certain features based on user roles.</p>
          </div>
      </div>
  </div>
</section>
...
export default Feutures_section