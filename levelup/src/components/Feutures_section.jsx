  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Detailed Reports and Analytics</h3>
              <p class="text-gray-500 dark:text-gray-400">Generate detailed reports and analytics to gain insights into your events .Make informed decosions with our comprehensive tools </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Team and Participant Management</h3>
              <p class="text-gray-500 dark:text-gray-400">Manage teams,players,andparticipants effortlessly.Add,remove,and update details with just a few clicks.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Real-Time Score Tracking</h3>
              <p class="text-gray-500 dark:text-gray-400">Keep track of scores in real-time.Our apps allows you to update scores instantly, ensuring everyone stays informed</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Customisable Event Settings</h3>
              <p class="text-gray-500 dark:text-gray-400">Tailor your events to meet specific needs with customisable settings.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Comprehensive Scheduling</h3>
              <p class="text-gray-500 dark:text-gray-400">Easily schedule matches and evens with our intutive tools, avoid conflict and ensure a smooth flow of events</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Our app is designed with simplicity in mind.Navigate through feutures easily with our clean and intuitive interface</p>
          </div>
      </div>
  </div>
</section>
